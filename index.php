          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header ">
                ...
                <p class="card-category">Registre los datos del cliente</p>
              </div>
              <div class="card-body ">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control textarea">Considere ingresar datos relevantes sobre el cliente</textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
