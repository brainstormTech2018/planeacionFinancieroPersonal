...
<body class="">
          ...
          <div class="navbar-wrapper">
            <div class="navbar-toggle">
              <button type="button" class="navbar-toggler">
                ...
                <span class="navbar-toggler-bar bar12"></span>
              </button>
            </div>
  ...
  <script>
        var cargue = function(vista){
           $.get("views/vista-vivienda.php?seccion="+vista)
