          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header ">
                <h5 class="card-title">Información de ingresos</h5>
                <p class="card-category">Es el monto correspondiente al dinero que
                                         se recibe en un determinado periodo de tiempo.</p>
              </div>
              <div class="card-body ">
                ...
                <form>
                  <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-8 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Prima</label>
                        <input type="email" class="form-control" placeholder="Email">
                      </div>
                    </div>
                     <div class="col-md-2 pr-1">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-8 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Bonificaciones</label>
                        <input type="email" class="form-control" placeholder="Email">
                      </div>
                    </div>
                     <div class="col-md-2 pr-1">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-8 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Honorarios</label>
                        <input type="email" class="form-control" placeholder="Email">
                      </div>
                    </div>
                     <div class="col-md-2 pr-1">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-8 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Subsidios</label>
                        <input type="email" class="form-control" placeholder="Email">
                      </div>
                    </div>
                     <div class="col-md-2 pr-1">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-8 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Dividendo de acciones</label>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-8 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Otros ingresos</label>
                        <input type="email" class="form-control" placeholder="$">
                      </div>
                    </div>
                     <div class="col-md-2 pr-1">
